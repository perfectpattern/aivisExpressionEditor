...
export const helpers = {
    ...
    extractEntries: function (parsedData, page = null, length = null) {
    ...
    getTimeMultiplier: function (timeUnit) {
        let multipliers = {
            ms: {
                text: "Milliseconds",
                multiplier: 1,
    ...
    timespanToMs: function (timespan) {
        //shortcuts
    ...
    msToTimespan: function (ms, magnitudes = null) {
